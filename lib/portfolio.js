...
function portfolioOptim(x, pm, lows, highs, shorts) {
    var i, j, k, Dmat, dvec, a1, a2, a3, a3neg, b3, Amat, bvec, res, pw, px, ps;
...
function nativeGetOptimalPortfolio(params, callback) {
    var symbols, referenceDate, targetReturn, lows, highs, shorts;
