...
function getOptionChainFromYahoo(params, callback) {
    ...
    var url = "http://uk.finance.yahoo.com/q/op?s=" + params.symbol,
        expiration,
        year,
        month,
        day;
    ...
    request({
        ...
        if (!err) {
            ...
            expDate = $(".yfnc_mod_table_title1 td").eq(1).text();
            ...
            calls = $(".yfnc_datamodoutline1").eq(0);
            puts = $(".yfnc_datamodoutline1").eq(1);
        }
